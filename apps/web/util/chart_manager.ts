...
export class ChartManager{
    ...
    constructor(ref: HTMLElement,initial_data:Klines,layout: {bg_color: string, color: string}){
    ...
    public update(updated_data: {new_candle_initiated: boolean, time: number} & Bar){
